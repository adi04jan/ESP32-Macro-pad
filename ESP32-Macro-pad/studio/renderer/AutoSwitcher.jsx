...
(function () {
  ...
  function AutoSwitcher({ enabled, onToggle, activeCtx, setActiveCtx, regenKey, recsFor, onPush, busy }) {
    ...
    return (
      <div className="view-enter">
        ...
        <div className="ctx-grid">
          ...
          >
            {recs.length === 0 && <div className="hint"><Icon name="sparkle" w="bold" /> No suggestions yet — hit “Regenerate all”.</div>}
            {recs.map((r) => (
              <div className="rec-row" key={r.key_num}>
                ...
                <IconBtn icon="arrow-line-down" title="Push to device" onClick={() => onPush && onPush(r)} />
              </div>
            ))}
